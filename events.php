...
<?php
  ...
  $doc = new DOMDocument();
  $doc->load('http://www.nycga.net/events/rss/');
...
<a href="content.php?title=<? echo $postTitle; ?>&page=<?echo $postLink;?>" data-role="button" data-theme="e"><? echo $postTitle; ?></a>
<a href="content.php?title=<? echo $postTitle; ?>&page=<?echo $postLink;?>" data-role="button"><? echo $postDesc; ?></a>
</div>
<? 
	if (++$count == 10)
		break;
